					...
					<Collapse navbar>
						<Nav className='ml-auto' navbar>
							...
							<UncontrolledDropdown nav inNavbar className='mr-2'>
								...
								<DropdownMenu right>
									<DropdownItem>
										<img src={usFlag} alt='English' width='20' className='align-middle mr-1' />
										<span className='align-middle'>English</span>
									</DropdownItem>
									<DropdownItem>
										<img src={esFlag} alt='Spanish' width='20' className='align-middle mr-1' />
										<span className='align-middle'>Spanish</span>
									</DropdownItem>
									<DropdownItem>
										<img src={deFlag} alt='German' width='20' className='align-middle mr-1' />
										<span className='align-middle'>German</span>
									</DropdownItem>
									<DropdownItem>
										<img src={nlFlag} alt='Dutch' width='20' className='align-middle mr-1' />
							...
							<UncontrolledDropdown nav inNavbar>
								...
								<DropdownMenu right>
									...
									<DropdownItem onClick={() => this.handleLoggedout()}>Sign out</DropdownItem>
								</DropdownMenu>
							</UncontrolledDropdown>
						</Nav>
					</Collapse>
